jQuery(function($) {
    ...
    var toWider = function() {
        ...
        weiboHideLeft = -200;
        showLeft = 60;
        $(".panel-cover").addClass('iswider');
        $(".content-wrapper").addClass('content-wrapper--pc').removeClass('content-wrapper--phone');
    ...
    var toNarrow = function() {
        ...
        $(".panel-cover").removeClass('iswider');
        $(".content-wrapper").addClass('content-wrapper--phone').removeClass('content-wrapper--pc');
